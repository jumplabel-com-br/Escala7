...
function Campanhas(){
	...
	join escala75_Easy7.ClientesCampanhas c on b.Id = c.IdCampanha
	join escala75_Easy7.Users d on c.IdUsuario = d.Id
	    ...
	    ${model.map((elem, i) => {
	    	return`
	    		<div class="carousel-fixed-item center">
	    		      <a class="btn waves-effect white grey-text darken-text-2" href="${elem.Caminho}" download="${elem.Caminho}">Baixar</a>
	    		</div>
